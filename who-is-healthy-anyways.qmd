...
compute_gap_reduction <- function(df, measure, type) {
    ...
    df %>% 
      ...
      round(2) } else if (type=="abs"){
          df %>% 
      filter(Measure == measure) %>%
      summarise(Reduction = (last(estimate) - first(estimate)) %>% round(2)) 
    } else
...
refs <- list(ref1, ref2, ref3, ref4, ref5, ref6, ref7, ref8, ref9, ref10, ref11)
  ...
  gap_reduction_messages <- function(race_coeffs, age_group) {
    ...
    for (measure in measures) {
      message(paste0("For ", measure, " in ", age_group, 
                     ", the percentage reduction in gap was ", 
                     compute_gap_reduction(race_coeffs, measure, type="perc"), "%"))
      message(paste0("For ", measure, " in ", age_group, 
                     ", the absolute reduction in gap was ", 
                     compute_gap_reduction(race_coeffs, measure, type="abs")))
    }
  }
...
Excluding individuals with various SDoH did not reduce the proportion of Asian individuals, nor did it reduce FEV~1~ or FVC gap between Asian and White individuals in the US (@suppfig-Asian). Among successive reference populations, the proportion of Mexican-Americans did decrease, confirming disproportionate impact of these exposures on Mexican-American population. Mexican-American and White populations had similar FEV~1~ and FVC at baseline, nonetheless, excluding individuals with various exposures resulted in slightly larger FEV~1~ and FVC values in Mexican-Americans compared to White individuals (@suppfig-Mexican). We observed somewhat similar results for non-Mexican Hispanic population (@suppfig-Hispanic).
