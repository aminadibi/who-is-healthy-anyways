...
refs_adult_homeowner_job_unexposed <- createCohortFlex("adult", exclusions =c("homeowner", "job unexposed") )
refs_youth_homeowner_job_unexposed <- createCohortFlex("youth", exclusions =c("homeowner", "job unexposed") )
plot_racial_gap_change(refs_adult_homeowner_job_unexposed, refs_youth_homeowner_job_unexposed) 

refs_adult_physically_active_job_unexposed <- createCohortFlex("adult", exclusions =c("homeowner", "job unexposed") )
refs_youth_physically_active_job_unexposed <- createCohortFlex("youth", exclusions =c("physically active", "job unexposed") )
plot_racial_gap_change(refs_adult_physically_active_job_unexposed, refs_youth_physically_active_job_unexposed) 


exlcude_all_pairs <- function(exclusionList=c("homeowner", 
                                              "job unexposed",
                                              "no maternal smoke", 
                                              "no 2ndhand smoke",
                                              "homeowner", 
  ...
  exclusionPairs <- combn(uniqueExclusionList, 2, simplify = FALSE)
  ...
  for (pair in exclusionPairs) {
    ...
    print(plot_racial_gap_change(refs_adult, refs_youth))
  }
}
