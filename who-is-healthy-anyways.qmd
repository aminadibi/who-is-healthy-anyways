...
plot_racial_gap_change <- function(refs_adult_list, refs_youth_list, single_sex = FALSE, 
  ...
  racial_gap_fev1_adult <- plot_racial_gap(race_coeffs_adult, "adults", measure="fev1")
  racial_gap_fvc_adult  <- plot_racial_gap(race_coeffs_adult, "adults", measure="fvc")

  racial_gap_fev1_youth <- plot_racial_gap(race_coeffs_youth, "youth",  measure="fev1", suppress_legend=TRUE)

    racial_gap_fvc_youth <- plot_racial_gap(race_coeffs_youth, "youth",  measure="fvc", suppress_legend=TRUE)
  ...
  gap_perc_black_youth <- plot_gap_perc(refs_df_percent_youth, "Youth (<20 yrs)", suppress_legend=TRUE)
    ...
    p <- (((gap_perc_black_youth/racial_gap_fev1_youth/racial_gap_fvc_youth) + 
           plot_layout(axes = "collect")) | 
          ((gap_perc_black_adult/racial_gap_fev1_adult/racial_gap_fvc_adult) + 
             plot_layout(axes = "collect")) ) + 
...
```{r, warning=FALSE, message=FALSE}
#| label: fig-popchange
#| fig-cap: Changes in population composition in successively more restrictive reference populations
...
```{r}
table1_black <- table1 %>% 
  filter(race_text_nhanes == "Non-Hispanic Black")
...
table1(~ age + race_text_nhanes + sex_text + 
          ...
          education_adults + now_attending_school + 
          healthy_diet + vigorous_work + moderate_work + vigorous_recreational + moderate_recreational + bmi 
          | birth_country+race_text_nhanes, table1, digits=2)
```
...
Mexican-American vs. White population
:::
...
Other Hispanic vs. White population
:::
...
Other Race Including Multiracial vs. White
:::

::: {#suppfig-mexicanblack}
```{r, message=F, warning=F}

refs_adult_mex_bl <- createCohort("adult", includedRace=c(4,1))
message("Adult counts:")
message(map_df(refs_adult_mex_bl, count))

refs_youth_mex_bl <- createCohort("youth", includedRace=c(4,1))
message("Youth counts:")
message(map_df(refs_youth_mex_bl, count))

plot_racial_gap_change(refs_adult_mex_bl, refs_youth_mex_bl, includedRace=c(4,1))
```
:::
