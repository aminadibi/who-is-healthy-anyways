...
# Plot
ggplot(LLN_fev1_adults_GLIgl, aes(x = index, 
                          y = below_llm, 
  ...
  geom_point() +
  labs(
    title = "Proportion of FEV1 Below GLI Global Lower Limit of Normal in Adults",
    x = "",
    y = "FEV1 Below LLN",
    color = ""
  ) +
...
# Plot
ggplot(LLN_fvc_adults_GLIgl, aes(x = index, 
                          y = below_llm, 
                          color = race_text_nhanes,
                          group = race_text_nhanes)) +
  geom_line() +
  geom_point() +
  labs(
    title = "Proportion of FVC Below GLI Global Lower Limit of Normal in Adults",
    x = "",
    y = "FVC Below LLN",
    color = ""
  ) +
...
# Plot
ggplot(LLN_fev1_youth_GLIgl, aes(x = index, 
                          y = below_llm, 
                          color = race_text_nhanes,
                          group = race_text_nhanes)) +
  geom_line() +
  geom_point() +
  labs(
    title = "Proportion of FEV1 Below GLI Global Lower Limit of Normal in Children",
    x = "",
    y = "FEV1 Below LLN",
    color = ""
  ) +
...
# Plot
ggplot(LLN_fvc_youth_GLIgl, aes(x = index, 
                          y = below_llm, 
                          color = race_text_nhanes,
                          group = race_text_nhanes)) +
  geom_line() +
  geom_point() +
  labs(
    title = "Proportion of FVC Below GLI Global Lower Limit of Normal in Children",
    x = "",
    y = "FVC Below LLN",
    color = ""
  ) +
