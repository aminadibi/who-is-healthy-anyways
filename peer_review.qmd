...
createCohortNHANESIII <- function (ageGroup, incomePovertyRatioOnly=FALSE, sex='all', BirthCountry='all', includedRace=c(3,4), leaveOneIn=FALSE) {
...
if (!incomePovertyRatioOnly & !AllostaticLoadOnly &!leaveOneIn) {
ref2 <- ref1 %>%
    srvyr::filter((is.na(mineral_dusts) | (mineral_dusts!=1)) & 
         (is.na(organic_dusts)   | (organic_dusts!=1)) & 
         (is.na(exhaust_fumes)   | (exhaust_fumes!=1)) & 
